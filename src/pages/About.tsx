  ...
  const values = [
    {
      ...
      description:
        "We believe visibility without action is noise. Everything we build enables execution, not just observation.",
    },
    {
      icon: Heart,
      title: "Customer-Obsessed",
      description:
        "Our success is measured by our customers' success. Their challenges drive our innovation and roadmap.",
    },
    {
      icon: Shield,
      title: "Enterprise-Ready",
      description:
        "We build for scale, security, and reliability from day one. No shortcuts, no compromises.",
    },
    {
      icon: Lightbulb,
      title: "Transparency",
      description:
        "Our AI explains its reasoning. Our pricing is clear. Our roadmap is shared with customers.",
    },
  ];

  const milestones = [
    { year: "2019", event: "Founded with a vision to transform operations" },
    { year: "2020", event: "First enterprise customer goes live" },
    { year: "2021", event: "Series A funding, team grows to 50+" },
    { year: "2022", event: "500+ enterprise customers globally" },
    { year: "2023", event: "AI Decision Engine launched" },
    { year: "2024", event: "Expanded to 30+ countries" },
  ];

  const team = [
    { name: "Sarah Chen", role: "CEO & Co-Founder", bio: "Ex-McKinsey, 15 years in supply chain" },
    { name: "Michael Torres", role: "CTO & Co-Founder", bio: "Ex-Google, AI/ML pioneer" },
    { name: "David Park", role: "VP of Engineering", bio: "Built platforms at scale" },
    { name: "Lisa Zhang", role: "VP of Product", bio: "Product leader, ex-Salesforce" },
    { name: "Robert Kim", role: "VP of Sales", bio: "Enterprise sales veteran" },
    { name: "Emma Wilson", role: "VP of Customer Success", bio: "Customer-first approach" },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-square rounded-2xl gradient-hero relative overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <Rocket className="w-32 h-32 text-primary-foreground/20" />
                </div>
              </div>
      ...
      <section className="py-20 lg:py-32 bg-card">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold">The NexusOps Story</h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
                whileHover={{ y: -5 }}
                className="text-center p-6 bg-card rounded-2xl border border-border hover:border-primary/30 transition-all"
              >
      ...
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative rounded-3xl overflow-hidden gradient-hero p-12 lg:p-20"
          >
