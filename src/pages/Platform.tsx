      ...
      <section className="py-20 lg:py-32 bg-card">
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">Every aspect of For Axis is designed for scale, security, and reliability.</p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative rounded-3xl overflow-hidden gradient-hero p-12 lg:p-20 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-lg text-primary-foreground/80 mb-8">Schedule a personalized demo and discover how For Axis can transform your operations.</p>
