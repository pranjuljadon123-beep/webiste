  ...
  const resourceCategories = [
    {
      icon: BookOpen,
      title: "Blog",
      description: "Expert insights on operations, AI, and digital transformation",
      href: "/blogs",
      cta: "Read Articles",
    },
    {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Resources & <span className="gradient-text">Learning</span>
            </h1>
            <p className="text-lg text-muted-foreground">
              Everything you need to understand modern operations and get the most from NexusOps.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Get the latest insights on operations and AI delivered to your inbox.
            </p>
