...
const solutionsData = {
  "order-management": {
    ...
    solution: "Daistrix Order Management creates a unified, real-time view of every order. From creation to completion, every change is tracked, every stakeholder is notified, and every related process stays synchronized. It's the foundation everything else builds on.",
    ...
    faqs: [
      { question: "How does this integrate with our existing ERP?", answer: "Daistrix integrates with all major ERPs via API or file-based integration. Orders can sync bidirectionally, with Daistrix serving as the operational layer on top." },
  ...
  "document-management": {
    ...
    solution: "Daistrix Document Intelligence auto-generates documents from operational data, manages versions intelligently, and links every document to its related transactions. Say goodbye to document chaos.",
    image: dashboardDocs,
    stats: [
  ...
  tracking: {
    ...
    solution: "Daistrix Tracking provides unified visibility across all carriers and modes, with predictive ETAs and proactive exception management. Know what's happening before it becomes a problem.",
  ...
  invoices: {
    ...
    solution: "Daistrix Invoice Reconciliation automates three-way matching, highlights discrepancies instantly, and streamlines the resolution process. Your finance team will thank you.",
  ...
  "ai-engine": {
    ...
    solution: "Daistrix AI Engine combines predictive analytics with explainable recommendations and controlled automation—AI you can trust and act on. Every recommendation shows its reasoning.",
    image: dashboardAi,
    stats: [
